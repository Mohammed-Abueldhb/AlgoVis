...
const WarshallPage = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const newFrames = generateWarshallWeightedFrames(graph.numVertices, directedEdges);
  ...
  // Create a GraphFrame for GraphVisualizer (convert from WarshallWeightedFrame)
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p>Finds transitive closure (reachability) between all pairs of vertices.</p>
                <ol className="list-decimal list-inside space-y-1 ml-1">
                  <li>Initialize matrix with direct edges (1 if edge exists, 0 otherwise)</li>
                ...
                <p className="mt-4 pt-4 border-t border-border">
                  <strong>Use Case:</strong> Dependency resolution, reachability analysis
                </p>
              </div>
            </div>
          </div>
