...
const FibonacciSearch = () => {
  ...
  const runSearch = () => {
    ...
    const newFrames = generateFibonacciSearchSteps([...array], Number(target));
    setFrames(newFrames);
    setCurrentFrame(0);
    setIsPlaying(false);
  };
    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <AlgorithmInfo
          ...
          description="A divide and conquer search algorithm that uses Fibonacci numbers to divide the search space. It works by dividing the array into parts based on Fibonacci numbers, making it efficient for sorted arrays."
          complexity={{
            best: "O(1)",
            avg: "O(log n)",
            worst: "O(log n)"
