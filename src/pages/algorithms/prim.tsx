...
import { generatePrimSteps, GraphFrame } from "@/lib/stepGenerators/prim";
...
const Prim = () => {
  ...
  const generateGraph = () => {
    ...
    setGraph(newGraph);
    const newFrames = generatePrimSteps(newGraph);
    setFrames(newFrames);
    setCurrentFrame(0);
    setIsPlaying(false);
  };
    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="container mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Prim's Algorithm Visualizer</h1>
          <p className="text-muted-foreground">Find minimum spanning tree using greedy approach</p>
        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="font-mono">O(E log V)</div>
                    </div>
                    <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p>1. Start from an arbitrary vertex</p>
                <p>2. Add minimum weight edge connecting tree to a new vertex</p>
                <p>3. Repeat until all vertices are included</p>
                <p className="mt-4 pt-4 border-t border-border">
                  <strong>Use Case:</strong> Network design, clustering
                </p>
              </div>
            </div>
          </div>
