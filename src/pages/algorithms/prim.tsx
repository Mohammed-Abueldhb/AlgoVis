    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center py-20">
          ...
          <h1 className="text-4xl font-bold mb-4">Prim's Algorithm Visualizer</h1>
          ...
          <div className="bg-card rounded-xl p-8 border border-border max-w-2xl mx-auto">
            <p className="text-muted-foreground mb-4">
              This visualizer is currently under development. Prim's Algorithm implementation coming soon!
            </p>
