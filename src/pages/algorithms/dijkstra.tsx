    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="container mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Dijkstra's Algorithm Visualizer</h1>
          <p className="text-muted-foreground">Find shortest path from source to all vertices</p>
        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="font-mono">O((V+E) log V)</div>
                    </div>
                    <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p>1. Initialize distances (0 for source, ∞ for others)</p>
                <p>2. Pick vertex with minimum distance</p>
                <p>3. Update distances to neighbors</p>
                <p>4. Mark vertex as visited</p>
                <p>5. Repeat until all vertices visited</p>
                <p className="mt-4 pt-4 border-t border-border">
                  <strong>Use Case:</strong> GPS navigation, network routing
                </p>
              </div>
            </div>
          </div>
